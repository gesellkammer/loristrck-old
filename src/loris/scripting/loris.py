...
class MarkerVector(_object):
    ...
    def __len__(self):
        """__len__(self) -> std::vector< Marker >::size_type"""
    ...
    def size(self):
        """size(self) -> std::vector< Marker >::size_type"""
    ...
    def begin(self):
        """begin(self) -> std::vector< Marker >::iterator"""
        return _loris.MarkerVector_begin(self)


    def end(self):
        """end(self) -> std::vector< Marker >::iterator"""
        return _loris.MarkerVector_end(self)


    def rbegin(self):
        """rbegin(self) -> std::vector< Marker >::reverse_iterator"""
        return _loris.MarkerVector_rbegin(self)


    def rend(self):
        """rend(self) -> std::vector< Marker >::reverse_iterator"""
    ...
    def get_allocator(self):
        """get_allocator(self) -> std::vector< Marker >::allocator_type"""
    ...
    def __init__(self, *args):
        ...
        __init__(self, arg2) -> MarkerVector
    ...
    def capacity(self):
        """capacity(self) -> std::vector< Marker >::size_type"""
...
class PartialListIterator(_object):
    ...
    def __iter__(self):
        ...
        """
        return _loris.PartialListIterator___iter__(self)
    ...
    def iterator(self):
        ...
        Return this iterator.
        """
        return _loris.PartialListIterator_iterator(self)


    def __next__(self):
        """
        __next__(self) -> Partial

        Return the next Partial in the PartialList that has not yet
        been returned by this iterator.
        """
        return _loris.PartialListIterator___next__(self)
...
class PartialIterator(_object):
    ...
    def __iter__(self):
        ...
        Return this iterator.
        """
        return _loris.PartialIterator___iter__(self)
    ...
    def iterator(self):
        ...
        Return this iterator.
        """
        return _loris.PartialIterator_iterator(self)


    def __next__(self):
        """
        __next__(self) -> BreakpointPosition

        Return the next Breakpoint in the Partial that has not yet
        been returned by this iterator.
        """
        return _loris.PartialIterator___next__(self)
...
class PartialList(_object):
    ...
    def channelize(self, *args):
        """
        channelize(self, refFreqEnvelope, refLabel)
        channelize(self, refFreq)
        ...
        """
        return _loris.PartialList_channelize(self, *args)


    def collate(self, *args):
        """
        collate(self, fadeTime, gapTime)
        collate(self, fadeTime)
        collate(self)
        ...
        are used.
        """
        return _loris.PartialList_collate(self, *args)
    ...
    def crop(self, t1, t2):
        ...
        """
        return _loris.PartialList_crop(self, t1, t2)


    def dilate(self, ivec, tvec):
        """
        dilate(self, ivec, tvec)
        ...
        """
        return _loris.PartialList_dilate(self, ivec, tvec)


    def distill(self, *args):
        """
        distill(self, fadeTime, gapTime)
        distill(self, fadeTime)
        distill(self)
        ...
        """
        return _loris.PartialList_distill(self, *args)


    def harmonify(self, *args):
        """
        harmonify(self, refLabel, env, threshold_dB)
        harmonify(self, refLabel, threshold_dB)
        ...
        unmodified. 
        """
        return _loris.PartialList_harmonify(self, *args)


    def resample(self, *args):
        """
        resample(self, interval, denseResampling=True, phaseCorrect=True)
        resample(self, interval, denseResampling=True)
        resample(self, interval)
        resample(self, timing, interval, phaseCorrect=False)
        resample(self, timing, interval)
        ...
        resampling.
        """
        return _loris.PartialList_resample(self, *args)


    def quantize(self, interval):
        """
        quantize(self, interval)
        ...
        """
        return _loris.PartialList_quantize(self, interval)
    ...
    def sift(self, *args):
        ...
        """
        return _loris.PartialList_sift(self, *args)


    def scaleAmplitude(self, *args):
        """
        scaleAmplitude(self, ampEnv)
        scaleAmplitude(self, val)

        Scale the amplitude of a Partial, or all Partials in a PartialList, according 
        to an envelope representing a time-varying amplitude scale value.
        """
        return _loris.PartialList_scaleAmplitude(self, *args)


    def scaleBandwidth(self, *args):
        """
        scaleBandwidth(self, bwEnv)
        scaleBandwidth(self, val)
        ...
        """
        return _loris.PartialList_scaleBandwidth(self, *args)


    def scaleFrequency(self, *args):
        """
        scaleFrequency(self, freqEnv)
        scaleFrequency(self, val)
        ...
        """
        return _loris.PartialList_scaleFrequency(self, *args)


    def scaleNoiseRatio(self, *args):
        """
        scaleNoiseRatio(self, noiseEnv)
        scaleNoiseRatio(self, val)

        Scale the relative noise content of a Partial, or all Partials in a PartialList,
        according to an envelope representing a (time-varying) noise energy 
        scale value.
        """
        return _loris.PartialList_scaleNoiseRatio(self, *args)


    def setBandwidth(self, *args):
        """
        setBandwidth(self, bwEnv)
        setBandwidth(self, val)
        ...
        """
        return _loris.PartialList_setBandwidth(self, *args)
...
class F0Estimate(_object):
    ...
    def __init__(self, amps, freqs, fmin, fmax, resolution):
        ...
        frequency).
        """
        this = _loris.new_F0Estimate(amps, freqs, fmin, fmax, resolution)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
...
class FundamentalFromPartials(FundamentalEstimator):
    ...
    __swig_setmethods__ = {}
    for _s in [FundamentalEstimator]:
    ...
    def __init__(self, *args):
        """
        __init__(self, precisionHz) -> FundamentalFromPartials
...
class FundamentalFromSamples(FundamentalEstimator):
    ...
    def __init__(self, *args):
        """
        __init__(self, winWidthHz, precisionHz) -> FundamentalFromSamples
...
class LinearEnvelope(Envelope):
    ...
    def __idiv__(self, div):
        ...
        Return a string describing the Loris version number.
        """
        return _loris.LinearEnvelope___idiv__(self, div)
    ...
    def __div__(self, div):
        ...
        LinearEnvelope.
        """
        return _loris.LinearEnvelope___div__(self, div)
...
class SynthesisParameters(_object):
    ...
    if _newclass:
        fadeTime = staticmethod(fadeTime)
    ...
    if _newclass:
        setFadeTime = staticmethod(setFadeTime)
    ...
    if _newclass:
        sampleRate = staticmethod(sampleRate)
    ...
    if _newclass:
        setSampleRate = staticmethod(setSampleRate)
    ...
    if _newclass:
        filterCoefsNumerator = staticmethod(filterCoefsNumerator)
    ...
    if _newclass:
        filterCoefsDenominator = staticmethod(filterCoefsDenominator)
    ...
    if _newclass:
        setFilterCoefs = staticmethod(setFilterCoefs)
...
class Channelizer(_object):
    ...
    if _newclass:
        computeStretchFactor = staticmethod(computeStretchFactor)
...
def collate(*args):
    """
    collate(partials, fadeTime, gapTime)
    collate(partials, fadeTime)
    collate(partials)
...
def distill(*args):
    """
    distill(partials, fadeTime, gapTime)
    distill(partials, fadeTime)
    distill(partials)
...
class Analyzer(_object):
    ...
    def storeResidueBandwidth(self, *args):
        """
        storeResidueBandwidth(self, regionWidth)
    ...
    def storeConvergenceBandwidth(self, *args):
        """
        storeConvergenceBandwidth(self, tolerance)
