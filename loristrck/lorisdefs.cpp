/* Generated by Cython 0.17b3 on Tue Apr 09 16:47:08 2013 */
...
#endif
#include <math.h>
#define __PYX_HAVE__ltrckr__lorisdefs
#define __PYX_HAVE_API__ltrckr__lorisdefs
#include "stdio.h"
#include "stdlib.h"
...
/* "ltrckr\lorisdefs.pyx":11
 * np.import_array()
 * 
 * ctypedef np.float64_t SAMPLE_t             # <<<<<<<<<<<<<<
 * 
 * # cdef class PartialList:
 */
typedef __pyx_t_5numpy_float64_t __pyx_t_6ltrckr_9lorisdefs_SAMPLE_t;
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/*--- Type declarations ---*/
struct __pyx_memoryview_obj;
struct __pyx_obj_6ltrckr_9lorisdefs___pyx_scope_struct__analyze;
...
/* "ltrckr\lorisdefs.pyx":41
 * @cython.boundscheck(False)
 * @cython.wraparound(False)
 * def analyze(double[::1] samples not None, double srate, double resolution, double window_width):             # <<<<<<<<<<<<<<
 *     """
...
/* Module declarations from 'ltrckr.lorisdefs' */
static PyTypeObject *__pyx_ptype_6ltrckr_9lorisdefs___pyx_scope_struct__analyze = 0;
...
static PyArrayObject *__pyx_f_6ltrckr_9lorisdefs_partial_to_array(Loris::Partial *); /*proto*/
...
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_6ltrckr_9lorisdefs_SAMPLE_t = { "SAMPLE_t", NULL, sizeof(__pyx_t_6ltrckr_9lorisdefs_SAMPLE_t), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "ltrckr.lorisdefs"
int __pyx_module_is_main_ltrckr__lorisdefs = 0;

/* Implementation of 'ltrckr.lorisdefs' */
...
static PyObject *__pyx_pf_6ltrckr_9lorisdefs_analyze(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_samples, double __pyx_v_srate, double __pyx_v_resolution, double __pyx_v_window_width); /* proto */
...
static char __pyx_k_48[] = "C:\\src\\ltrckr\\ltrckr\\lorisdefs.pyx";
static char __pyx_k_49[] = "ltrckr.lorisdefs";
...
static PyObject *__pyx_gb_6ltrckr_9lorisdefs_2generator(__pyx_GeneratorObject *__pyx_generator, PyObject *__pyx_sent_value); /* proto */

/* Python wrapper */
static PyObject *__pyx_pw_6ltrckr_9lorisdefs_1analyze(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6ltrckr_9lorisdefs_analyze[] = "analyze(__Pyx_memviewslice samples, double srate, double resolution, double window_width)\n\n    returns a generator. it yields a tuple (label, data) for each partial, where data is\n    a 2D numpy array with columns\n    \n    time freq amp phase bw\n\n    samples: an array representing a mono sndfile. \n             NB: if you have a stereo array, a channel can be selected with:\n             sound[:,0]  --> the \"left\" channel\n             sound[:,1]  --> the \"right\" channel\n    srate:   the sampling rate\n    resolution: in Hz (as passed to Loris's Analyzer)\n    window_width: in Hz.\n    ";
static PyMethodDef __pyx_mdef_6ltrckr_9lorisdefs_1analyze = {__Pyx_NAMESTR("analyze"), (PyCFunction)__pyx_pw_6ltrckr_9lorisdefs_1analyze, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_6ltrckr_9lorisdefs_analyze)};
static PyObject *__pyx_pw_6ltrckr_9lorisdefs_1analyze(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__samples,&__pyx_n_s__srate,&__pyx_n_s__resolution,&__pyx_n_s__window_width,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__srate)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("analyze", 1, 4, 4, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__resolution)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("analyze", 1, 4, 4, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__window_width)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("analyze", 1, 4, 4, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "analyze") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_samples = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[0]); if (unlikely(!__pyx_v_samples.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_srate = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_srate == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_resolution = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_resolution == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_window_width = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_window_width == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("analyze", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("ltrckr.lorisdefs.analyze", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(((PyObject *)__pyx_v_samples.memview) == Py_None)) {
    PyErr_Format(PyExc_TypeError, "Argument 'samples' must not be None"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_r = __pyx_pf_6ltrckr_9lorisdefs_analyze(__pyx_self, __pyx_v_samples, __pyx_v_srate, __pyx_v_resolution, __pyx_v_window_width);
  goto __pyx_L0;
  __pyx_L1_error:;
  __pyx_r = NULL;
  __pyx_L0:;
...
static PyObject *__pyx_pf_6ltrckr_9lorisdefs_analyze(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_samples, double __pyx_v_srate, double __pyx_v_resolution, double __pyx_v_window_width) {
  struct __pyx_obj_6ltrckr_9lorisdefs___pyx_scope_struct__analyze *__pyx_cur_scope;
  ...
  __pyx_cur_scope = (struct __pyx_obj_6ltrckr_9lorisdefs___pyx_scope_struct__analyze *)__pyx_ptype_6ltrckr_9lorisdefs___pyx_scope_struct__analyze->tp_new(__pyx_ptype_6ltrckr_9lorisdefs___pyx_scope_struct__analyze, __pyx_empty_tuple, NULL);
  ...
  {
    __pyx_GeneratorObject *gen = __Pyx_Generator_New((__pyx_generator_body_t) __pyx_gb_6ltrckr_9lorisdefs_2generator, (PyObject *) __pyx_cur_scope); if (unlikely(!gen)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_gb_6ltrckr_9lorisdefs_2generator(__pyx_GeneratorObject *__pyx_generator, PyObject *__pyx_sent_value) /* generator body */
{
  struct __pyx_obj_6ltrckr_9lorisdefs___pyx_scope_struct__analyze *__pyx_cur_scope = ((struct __pyx_obj_6ltrckr_9lorisdefs___pyx_scope_struct__analyze *)__pyx_generator->closure);
  PyObject *__pyx_r = NULL;
 ...
 */
  __pyx_t_1 = 0;
  __pyx_cur_scope->__pyx_v_samples0 = (&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_cur_scope->__pyx_v_samples.data) + __pyx_t_1)) ))));

  /* "ltrckr\lorisdefs.pyx":58
 *     cdef loris.Analyzer* an = new loris.Analyzer(resolution, window_width)
 *     cdef double *samples0 = &(samples[0])              #<double*> np.PyArray_DATA(samples)
 *     cdef double *samples1 = &(samples[<int>(samples.size-1)]) #samples0 + <int>(samples.size - 1)             # <<<<<<<<<<<<<<
 *     an.analyze(samples0, samples1, srate)
 *     cdef loris.L_PartialList partials = an.partials()
 */
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_cur_scope->__pyx_v_samples, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 58; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__size); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 58; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_cur_scope->__pyx_v_samples1 = (&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_cur_scope->__pyx_v_samples.data) + __pyx_t_5)) ))));

  /* "ltrckr\lorisdefs.pyx":59
 *     cdef double *samples0 = &(samples[0])              #<double*> np.PyArray_DATA(samples)
 *     cdef double *samples1 = &(samples[<int>(samples.size-1)]) #samples0 + <int>(samples.size - 1)
 *     an.analyze(samples0, samples1, srate)             # <<<<<<<<<<<<<<
 *     cdef loris.L_PartialList partials = an.partials()
 *     cdef loris.L_PartialListIterator p_it = partials.begin()
 */
  ...
  /* "ltrckr\lorisdefs.pyx":60
 *     cdef double *samples1 = &(samples[<int>(samples.size-1)]) #samples0 + <int>(samples.size - 1)
 *     an.analyze(samples0, samples1, srate)
 *     cdef loris.L_PartialList partials = an.partials()             # <<<<<<<<<<<<<<
 *     cdef loris.L_PartialListIterator p_it = partials.begin()
 *     cdef loris.L_PartialListIterator p_end = partials.end()
 */
  __pyx_cur_scope->__pyx_v_partials = __pyx_cur_scope->__pyx_v_an->partials();

  /* "ltrckr\lorisdefs.pyx":61
 *     an.analyze(samples0, samples1, srate)
 *     cdef loris.L_PartialList partials = an.partials()
 *     cdef loris.L_PartialListIterator p_it = partials.begin()             # <<<<<<<<<<<<<<
 *     cdef loris.L_PartialListIterator p_end = partials.end()
 *     cdef loris.L_Partial partial
 */
  __pyx_cur_scope->__pyx_v_p_it = __pyx_cur_scope->__pyx_v_partials.begin();

  /* "ltrckr\lorisdefs.pyx":62
 *     cdef loris.L_PartialList partials = an.partials()
 *     cdef loris.L_PartialListIterator p_it = partials.begin()
 *     cdef loris.L_PartialListIterator p_end = partials.end()             # <<<<<<<<<<<<<<
 *     cdef loris.L_Partial partial
 ...
 */
  while (1) {
    __pyx_t_6 = (__pyx_cur_scope->__pyx_v_p_it != __pyx_cur_scope->__pyx_v_p_end);
    if (!__pyx_t_6) break;

    /* "ltrckr\lorisdefs.pyx":66
 *     cdef int n = 0
 *     while p_it != p_end:
 *         partial = deref(p_it)             # <<<<<<<<<<<<<<
 *         yield partial.label(), partial_to_array(&partial)
 ...
 * 
 */
    __pyx_t_2 = PyInt_FromLong(__pyx_cur_scope->__pyx_v_partial.label()); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 67; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = ((PyObject *)__pyx_f_6ltrckr_9lorisdefs_partial_to_array((&__pyx_cur_scope->__pyx_v_partial))); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 67; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
...
/* "ltrckr\lorisdefs.pyx":72
 * @cython.boundscheck(False)
 * @cython.wraparound(False)
 * cdef np.ndarray partial_to_array(loris.L_Partial* p):             # <<<<<<<<<<<<<<
 *     cdef int numbps = p.numBreakpoints()
 *     cdef np.ndarray [SAMPLE_t, ndim=2] arr = np.empty((numbps, 5), dtype='float64')
 */

static PyArrayObject *__pyx_f_6ltrckr_9lorisdefs_partial_to_array(Loris::Partial *__pyx_v_p) {
  int __pyx_v_numbps;
 ...
 */
  ...
  /* "ltrckr\lorisdefs.pyx":74
 * cdef np.ndarray partial_to_array(loris.L_Partial* p):
 *     cdef int numbps = p.numBreakpoints()
 *     cdef np.ndarray [SAMPLE_t, ndim=2] arr = np.empty((numbps, 5), dtype='float64')             # <<<<<<<<<<<<<<
 *     cdef double[:, :] a = arr
 *     cdef loris.L_Partial_Iterator it  = p.begin()
 */
  ...
  __pyx_t_1 = PyInt_FromLong(__pyx_v_numbps); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  if (PyDict_SetItem(__pyx_t_3, ((PyObject *)__pyx_n_s__dtype), ((PyObject *)__pyx_n_s__float64)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_4 = PyObject_Call(__pyx_t_2, ((PyObject *)__pyx_t_1), ((PyObject *)__pyx_t_3)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_5 = ((PyArrayObject *)__pyx_t_4);
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_arr.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_6ltrckr_9lorisdefs_SAMPLE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
  ...
  /* "ltrckr\lorisdefs.pyx":75
 *     cdef int numbps = p.numBreakpoints()
 *     cdef np.ndarray [SAMPLE_t, ndim=2] arr = np.empty((numbps, 5), dtype='float64')
 *     cdef double[:, :] a = arr             # <<<<<<<<<<<<<<
 *     cdef loris.L_Partial_Iterator it  = p.begin()
 *     cdef loris.L_Partial_Iterator end = p.end()
 */
  ...
  /* "ltrckr\lorisdefs.pyx":76
 *     cdef np.ndarray [SAMPLE_t, ndim=2] arr = np.empty((numbps, 5), dtype='float64')
 *     cdef double[:, :] a = arr
 *     cdef loris.L_Partial_Iterator it  = p.begin()             # <<<<<<<<<<<<<<
 *     cdef loris.L_Partial_Iterator end = p.end()
 *     cdef loris.L_Breakpoint bp
 */
  __pyx_v_it = __pyx_v_p->begin();

  /* "ltrckr\lorisdefs.pyx":77
 *     cdef double[:, :] a = arr
 *     cdef loris.L_Partial_Iterator it  = p.begin()
 *     cdef loris.L_Partial_Iterator end = p.end()             # <<<<<<<<<<<<<<
 *     cdef loris.L_Breakpoint bp
 ...
 */
  ...
  __Pyx_AddTraceback("ltrckr.lorisdefs.partial_to_array", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_arr.rcbuffer->pybuffer);
...
static PyObject *__pyx_tp_new_6ltrckr_9lorisdefs___pyx_scope_struct__analyze(PyTypeObject *t, CYTHON_UNUSED PyObject *a, CYTHON_UNUSED PyObject *k) {
  struct __pyx_obj_6ltrckr_9lorisdefs___pyx_scope_struct__analyze *p;
  PyObject *o = (*t->tp_alloc)(t, 0);
  if (!o) return 0;
  p = ((struct __pyx_obj_6ltrckr_9lorisdefs___pyx_scope_struct__analyze *)o);
...
static void __pyx_tp_dealloc_6ltrckr_9lorisdefs___pyx_scope_struct__analyze(PyObject *o) {
  struct __pyx_obj_6ltrckr_9lorisdefs___pyx_scope_struct__analyze *p = (struct __pyx_obj_6ltrckr_9lorisdefs___pyx_scope_struct__analyze *)o;
...
static PyMethodDef __pyx_methods_6ltrckr_9lorisdefs___pyx_scope_struct__analyze[] = {
  {0, 0, 0, 0}
};
...
static PyTypeObject __pyx_type_6ltrckr_9lorisdefs___pyx_scope_struct__analyze = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("ltrckr.lorisdefs.__pyx_scope_struct__analyze"), /*tp_name*/
  sizeof(struct __pyx_obj_6ltrckr_9lorisdefs___pyx_scope_struct__analyze), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_6ltrckr_9lorisdefs___pyx_scope_struct__analyze, /*tp_dealloc*/
  0, /*tp_print*/
  0, /*tp_getattr*/
  0, /*tp_setattr*/
  #if PY_MAJOR_VERSION < 3
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_6ltrckr_9lorisdefs___pyx_scope_struct__analyze, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_6ltrckr_9lorisdefs___pyx_scope_struct__analyze, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static PyTypeObject __pyx_type___pyx_array = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("ltrckr.lorisdefs.array"), /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("ltrckr.lorisdefs.Enum"), /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("ltrckr.lorisdefs.memoryview"), /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("ltrckr.lorisdefs._memoryviewslice"), /*tp_name*/
 ...
 *     returns a generator. it yields a tuple (label, data) for each partial, where data is
 */
  __pyx_k_tuple_46 = PyTuple_New(12); if (unlikely(!__pyx_k_tuple_46)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#endif
{
  ...
  if (__pyx_module_is_main_ltrckr__lorisdefs) {
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_6ltrckr_9lorisdefs___pyx_scope_struct__analyze) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_6ltrckr_9lorisdefs___pyx_scope_struct__analyze = &__pyx_type_6ltrckr_9lorisdefs___pyx_scope_struct__analyze;
 ...
 *     returns a generator. it yields a tuple (label, data) for each partial, where data is
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6ltrckr_9lorisdefs_1analyze, NULL, __pyx_n_s_49); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__analyze, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "ltrckr\lorisdefs.pyx":1
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init ltrckr.lorisdefs", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init ltrckr.lorisdefs");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
